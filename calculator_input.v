module calculator_core(
    ...
    always @(posedge clk or posedge rst) begin
        if(rst) begin
            ...
            // 7. operations
            if (sw[0] == 1 && sw[1] == 0 && sw[2] == 0) op_reg <= 2'b00; // ADD
            else if (sw[1] == 1 && sw[0] == 0 && sw[2] == 0) op_reg <= 2'b01; // SUB
            else if (sw[2] == 1 && sw[1] == 0 && sw[0] == 0) op_reg <= 2'b10; // MUL
            else op_reg <= 2'b11; // DIV or Default
